---
name: plan-year
description: "Run an annual 10x strategic planning session using Dan Sullivan and Benjamin Hardy's \"10x Is Easier Than 2x\" methodology. Establishes a 3-year 10x vision, the 80% to eliminate and 20% to amplify, three annual initiatives, a decision filter, and quarterly milestones. Use when the user wants to plan or review the year, set a multi-year vision, choose this year's focus, or develop annual business strategy. Triggers on /plan-year, \"annual planning\", \"annual review\", \"yearly plan\", \"10x vision\", \"map out next year\", \"3-year vision\", or \"what should I focus on this year\". Top of the strategy cascade (/plan-year -> /plan-quarter -> /plan-month -> /plan-week); use plan-content for content calendars. Reads all client context from BRAND.md at runtime. Produces a branded interactive HTML strategic plan and spreadsheet tracker. Ask one question at a time; challenge 2x thinking and apply WHO not HOW."
---
